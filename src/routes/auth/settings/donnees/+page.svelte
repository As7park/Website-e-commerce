...
<div class="mx-auto max-w-[640px] px-6 pt-10 pb-12">
	...
	<h1 class="mb-6 text-2xl font-semibold">Mes données</h1>

	<Card.Root class="mb-6">
		<Card.Header>
			<Card.Title>Exporter mes données</Card.Title>
			<Card.Description>
				Téléchargez un fichier JSON contenant vos données personnelles : profil, adresses,
				commandes, factures, avis, questions produit, liste d'envies, retours (droit à la
