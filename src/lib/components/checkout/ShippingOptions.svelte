									...
									<div class="flex items-center justify-between">
										<div class="flex-1">
											<div class="font-medium">
												{option.carrierCode?.toUpperCase() || 'TRANSPORTEUR INCONNU'}
											</div>
											...
											{:else if option.carrierCode === 'colissimo'}
												<div class="mt-2 text-xs text-muted-foreground">
													{#if option.type === 'service_point'}
														<p>✓ Point relais - Retrait en bureau de poste</p>
													{:else if option.productName.includes('Signature')}
		...
		<Card.Content>
			<div class="p-4 rounded-lg border bg-blue-50 dark:bg-blue-950/20">
				<p class="text-sm text-blue-700 dark:text-blue-300">
					...
					Les commandes de projets sur-mesure ne nécessitent pas de frais de livraison. Votre commande
					sera traitée sans coût de transport supplémentaire.
				</p>
			</div>
		</Card.Content>
	</Card.Root>
